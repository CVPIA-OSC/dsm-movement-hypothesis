...
fall_run_hypothesis <- read_rds("data/fall-run-juveniles-at-chipps-clean-new-metric.rds") %>%
  filter(watershed %in% fall_run_watersheds)

spring_run_hypothesis <- read_rds("data/spring-run-juveniles-at-chipps-clean-new-metric.rds") %>%
  filter(watershed %in% spring_run_watersheds)

winter_run_hypothesis <- read_rds("data/winter-run-juveniles-at-chipps-clean-new-metric.rds") %>%
